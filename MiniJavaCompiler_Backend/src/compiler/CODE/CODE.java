...
public class CODE {
	...
	private int addr;
	private HashMap<MJMethod, LC3label> methodLabel = new HashMap<MJMethod,LC3label>();
...
//			}
	...
	public void setLabel(MJMethod m, LC3label l) {
		methodLabel.put(m,l);
	}

	public LC3 getLabel(MJMethod meth) {
		return methodLabel.get(meth);
	}
